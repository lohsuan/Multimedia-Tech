...
cv2.imwrite("./floor_out_blurred.jpg", img_blurred)
...
# img = cv2.dilate(img, np.ones((3, 3)), iterations=3)
...
# lines = cv2.HoughLines(img, 3, np.pi/180, threshold)
...
cv2.imwrite("./floor_out3.jpg", img_3)
